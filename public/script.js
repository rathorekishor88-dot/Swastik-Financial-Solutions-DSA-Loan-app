...
// Data loading functions - FIXED: Ensure data is properly loaded without clearing
async function loadAllData() {
    try {
        ...
        if (result.success) {
            ...
            showNotification('Failed to load data: ' + result.message, 'error');
        }
    } catch (error) {
...
async function loadMsmeData() {
    try {
        ...
        showNotification('Error loading MSME data', 'error');
    }
}
...
async function loadPlData() {
    try {
        ...
        showNotification('Error loading PL data', 'error');
    }
}
...
async function loadPayoutData() {
    try {
        ...
        showNotification('Error loading payout data', 'error');
    }
}
...
async function handleVehicleSubmit(e) {
    ...
    try {
        ...
        console.log('Saving vehicle case:', data);
        ...
        if (result.success) {
            ...
            e.target.reset();
            resetEditState();
            // Reload data to ensure everything is synchronized
            await loadAllData();
            loadVehicleData();
        } else {
            showNotification(result.message, 'error');
        ...
        console.error('Error saving vehicle case:', error);
